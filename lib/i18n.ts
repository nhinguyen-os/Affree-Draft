...
const EN_DICT: Record<string, string> = {
  ...
  "{chain} · {n} nơi bán": "{chain} · {n} stores",
  ...
  "Trợ lý AAAI đã đặt {n} món từ {m} cửa hàng — mỗi cửa hàng 1 mã đơn riêng:": "The assistant ordered {n} items from {m} stores — each store has its own order code:",
  ...
  "{n} nguồn": "{n} sources",
  "{n} cửa hàng · {m} mã đơn": "{n} stores · {m} orders",
  "Giao tận nơi": "Home delivery",
  "Nhận tại cửa hàng": "Store pickup",
  "Không phí SHIP": "No shipping fee",
  "Giao từ:": "Delivered from:",
  "Cửa hàng nhận:": "Pickup store:",
  "Nhập đủ tên, số điện thoại để bắt đầu.": "Enter your name and phone to start.",
  "{n} túi": "{n} bundles",
  "Sản phẩm": "Product",
  "sản phẩm": "products",
  "cửa hàng": "stores",
  ...
  "Xem tất cả sản phẩm của cửa hàng": "View all products of this store",
  ...
  "Affree không liên kết, không đại diện cho các nhà bán được hiển thị (Bách Hóa Xanh, Co.op Online…). Đơn hàng được xác lập trực tiếp giữa bạn và nhà bán trên website chính chủ của họ. Affree không nhìn thấy và không lưu thông tin thanh toán của bạn.":
    "Affree is not affiliated with and does not represent the sellers shown (Bách Hóa Xanh, Co.op Online…). Orders are established directly between you and the seller on their official website. Affree never sees or stores your payment information.",
  "Bạn chọn và thực hiện thanh toán trên website của từng siêu thị. Affree không thu thập thông tin thanh toán.":
    "You choose and complete payment on each supermarket's website. Affree does not collect payment information.",
  "Trợ lý chỉ điền sẵn thông tin. Bạn kiểm tra và tự bấm \"Đặt hàng\" trên từng trang chính chủ.":
    "The assistant only pre-fills information. You review and click \"Place order\" yourself on each official site.",
  "Chưa có phiên đặt hàng nào": "No ordering session yet",
  "Đang mở…": "Opening…",
  "Đang mở trang {store}…": "Opening {store}…",
  "Kết nối phiên trình duyệt an toàn tới trang chính chủ — thông tin giao hàng sẽ được điền sẵn từ đơn nháp.":
    "Connecting a secure browser session to the store's official website — delivery details will be pre-filled from your draft order.",
  "Trả lời câu hỏi ở khung bên phải để bắt đầu phiên đặt hàng.": "Answer the questions in the right pane to start your ordering session.",
  "Câu hỏi": "Questions",
  "Affree sẽ mở phiên trình duyệt an toàn tới từng siêu thị, điền sẵn thông tin giao hàng từ đơn nháp — và chờ bạn xác nhận.":
    "Affree will open a secure browser session to each supermarket, pre-fill delivery info from your draft order — and wait for your confirmation.",
  "Quét hoặc tải QR về để chuyển khoản cho cửa hàng.": "Scan or download the QR to transfer payment to the store.",
  "Tải QR về": "Download QR",
