...
const CONFIG: Record<string, OrderSourceConfig> = {
  ...
  premiumoutlets: {
    ...
    needSlot: false,
    captcha: true,
    payments: ["Thẻ", "PayPal / Shop Pay", "Ví / Apple Pay (tuỳ merchant)"],
    note: "Premium Outlets chỉ là trang referral; checkout thật có thể chuyển sang Shop Simon hoặc merchant ngoài.",
    requirements: ["Họ tên", "Email checkout", "Số điện thoại quốc tế", "Địa chỉ giao", "Có thể cần đăng nhập ở site đích"],
  },
