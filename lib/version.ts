...
export const VERSION_HISTORY: VersionEntry[] = [
  {
    ...
    children: [{
      ...
      highlights: [
        ...
        "Đặt nhiều nơi một lượt: các nơi được xử lý cùng lúc (song song) cho nhanh, không phải chờ lần lượt; thẻ đã lưu hiện thêm thông tin khi mở xem",
        "Giỏ hàng: thêm nút xoá (🗑) để bỏ nhanh một món khỏi giỏ",
        "Tình trạng 'Còn hàng / Hết hàng' hiển thị theo dữ liệu tồn thực tế của điểm bán",
