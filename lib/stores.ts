...
export const SOURCE_META: Record<string, SourceMeta> = {
  ...
  premiumoutlets: { label: "Premium Outlets", color: "#111827", home: "https://www.premiumoutlets.com", online: true, currency: "USD" },
...
/**
 * Nhãn nguồn/chuỗi suy TỪ store-id khi offer không map được cửa hàng vật lý
 * (id kiểu "PNJ_00004" / "COOP_00019" — thuộc hệ id nguồn, khác id GIS của map).
 * Dùng để card ở brand/chain mode vẫn hiện tên chuỗi ("PNJ", "Co.opmart") thay vì bỏ trống.
 * Trả "" nếu không suy ra được gì có nghĩa.
 */
export function sourceLabelFromStoreId(storeId: string): string {
  const key = chainBaseKey(storeId as Chain);
  if (!key) return "";
  return chainLabel(key as Chain);
}
...
export const STORES: Store[] = [
    ...
    },
    {
        ...
        address: '78 Xô Viết Nghệ Tĩnh, Bình Thạnh',
        lat: 10.8015,
        lng: 106.711,
        website: 'https://www.bachhoaxanh.com'
    },
    {
        id: 'cc-q3',
        chain: 'concung',
        name: 'Con Cưng Lê Văn Sỹ',
        address: '200 Lê Văn Sỹ, Quận 3',
        lat: 10.7905,
        lng: 106.6772,
    ...
    },
    {
        id: 'cc-pn',
        chain: 'concung',
        name: 'Con Cưng Phan Đăng Lưu',
        address: '55 Phan Đăng Lưu, Phú Nhuận',
        lat: 10.7985,
        lng: 106.684,
        website: 'https://concung.com'
    },
    {
        ...
        address: '189C Cống Quỳnh, Quận 1',
        lat: 10.7665,
        lng: 106.689,
    ...
    },
    {
        id: 'coop-bt',
        chain: 'coop',
        name: 'Co.opmart Đinh Tiên Hoàng',
        address: '127 Đinh Tiên Hoàng, Bình Thạnh',
        lat: 10.799,
        lng: 106.7035,
        website: 'https://cooponline.vn'
    },
    ...
    // chuẩn, sheet thắng khi trùng id — xem /api/stores); sheet đổi thì cập nhật dòng này theo.
    {
        ...
        chain: 'astrabean',
        name: 'Astra Bean',
        address: '9878 Bolsa Ave, Westminster, California CA 92683',
        lat: 33.7868893,
        lng: -117.896468,
    ...
    {
        id: 'PremiumOutlets_00034',
        chain: 'premiumoutlets',
        name: 'Las Vegas North Premium Outlets',
        address: '875 S Grand Central Pkwy, Las Vegas, NV 89106, USA',
        lat: 36.1636508,
        lng: -115.1577492,
        website: 'https://www.premiumoutlets.com/outlet/las-vegas-north',
        currency: 'USD'
    }
]
