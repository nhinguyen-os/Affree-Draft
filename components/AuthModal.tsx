            ...
            <div className="space-y-3">
              ...
              <label className="block">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
                />
              </label>
              {error && <p className="text-xs font-medium text-rose-600">{error}</p>}
              <button
          ...
          {phase === "otp" && (
            <div className="space-y-3">
              ...
              <input
                ...
                placeholder="______"
                className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-center font-mono text-lg tracking-[0.5em] outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
              />
              {error && <p className="text-xs font-medium text-rose-600">{error}</p>}
              <button
