      ...
      <div className="relative">
        ...
        {albums.map((al) => {
          ...
          return (
            <div
              key={al.id}
              className={`group relative flex h-full ${cardW} flex-col rounded-xl border border-slate-200 bg-white p-3 text-left transition duration-200 hover:-translate-y-1 hover:border-orange-400`}
            >
        ...
        {allSongs.map((s) => (
          <div
            key={`song-${s.vid}`}
            className={`group relative flex h-full ${cardW} flex-col rounded-xl border border-slate-200 bg-white p-3 text-left transition duration-200 hover:-translate-y-1 hover:border-pink-400`}
          >
                <div className="mb-2 flex flex-wrap items-start gap-1">
