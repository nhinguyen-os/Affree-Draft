...
export default function CartModal({
  ...
  /** Click tên cửa hàng → mở trang bán hàng của cửa hàng đó (cha đóng giỏ + mở StoreProductsPage). */
  ...
  // Bấm "Đặt hàng ngay" → khởi động mô phỏng trợ lý AAAI (thay vì đặt tức thì).
  function startAgent() {
          ...
          {phase === "done" ? (
            ...
            <>
              ...
              {storeGroups.map((group) => (
                ...
                >
                  {/* Store header — logo căn TRÊN (items-start) cho ngang hàng tên chuỗi, không nằm giữa khối nhiều dòng. */}
                  <div className="mb-2.5 flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <button
                        ...
                        onClick={() => onOpenStore?.(group.items[0].offer.store)}
        ...
        {phase === "cart" && (
          <div className="shrink-0 border-t border-slate-100 px-4 py-3">
            ...
            >
              ...
              {t("Đặt hàng ngay →").replace(/\s*→\s*/g, "")} ({storeGroups.length} {t("cửa hàng")})
            </button>
            {orderHint && (
