...
async function getCoopAccounts() {
  ...
  if (!accounts.length) throw new Error("Không tìm thấy tài khoản Co.op hợp lệ trong sheet.");
  return accounts;
}

module.exports = { getWalmartAccount, getCoopAccount, getCoopAccounts, parseCsv, fetchSheetCsv, withSheetGid };
