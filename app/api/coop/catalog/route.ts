...
import { coopSearchToCatalog, searchCoopProducts } from "@/integrations/coop/backend/client";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const result = await searchCoopProducts({
      query,
    ...
    return NextResponse.json(coopSearchToCatalog(result));
  } catch (err) {
